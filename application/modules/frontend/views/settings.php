                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseOne" class="panel-collapse collapse" aria-expanded="false"
                                                ...
                                                <div class="panel-body">
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('title'); ?></label>
                                                                ...
                                                                <div>
                                                                    <span class="btn btn-white btn-file">
                                                                        <span class="fileupload-new"><i
                                                                                class="fa fa-paper-clip"></i> Select
                                                                            image</span>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('address'); ?></label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('phone'); ?></label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('emergency'); ?></label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('support_number'); ?></label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('hospital_email'); ?></label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('currency'); ?></label>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseTwo" class="panel-collapse collapse" aria-expanded="false"
                                                ...
                                                <div class="panel-body">
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('footer')." ".lang('description'); ?></label>
                                                        <!-- textarea -->
                                                        <textarea class="form-control ckeditor" id="editor1"
                                                            name="description" id="exampleInputEmail1"
                                                            placeholder="Footer Description"><?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="form-group ">
                                                            <label
                                                                for="exampleInputEmail1"><?php echo lang('block_1_text_under_title'); ?></label>
                                                            <input type="text" class="form-control"
                                                                name="block_1_text_under_title" id="exampleInputEmail1"
                                                                value='<?php
                                                        ...
                                                        <div class="form-group ">
                                                            <label
                                                                for="exampleInputEmail1"><?php echo lang('service_block__text_under_title'); ?></label>
                                                            <input type="text" class="form-control"
                                                                name="service_block__text_under_title"
                                                                id="exampleInputEmail1" value='<?php
                                                        ...
                                                        <div class="form-group ">
                                                            <label
                                                                for="exampleInputEmail1"><?php echo lang('doctor_block__text_under_title'); ?></label>
                                                            <input type="text" class="form-control"
                                                                name="doctor_block__text_under_title"
                                                                id="exampleInputEmail1" value='<?php
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseFour" class="panel-collapse collapse" aria-expanded="false"
                                                ...
                                                <div class="panel-body">
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('apppointment_block_title'); ?></label>
                                                        <input type="text" class="form-control" name="appointment_title"
                                                            id="exampleInputEmail1" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('apppointment_block_subtitle'); ?></label>
                                                        <input type="text" class="form-control"
                                                            name="appointment_subtitle" id="exampleInputEmail1" value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('apppointment_block_description'); ?></label>
                                                        <input type="text" class="form-control"
                                                            name="appointment_description" id="exampleInputEmail1"
                                                            value='<?php
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            class="control-label"><?php echo lang('apppointment_block_image'); ?></label>
                                                        <div class="">
                                                            <div class="fileupload fileupload-new"
                                                                data-provides="fileupload">
                                                                <div class="fileupload-new thumbnail" style="width: 200px; height: <?php if(!empty($settings->logo)) {
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div id="collapseThree" class="panel-collapse collapse"
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('facebook_id'); ?></label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('twitter_id'); ?></label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('twitter_username'); ?></label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('google_id'); ?></label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('youtube_id'); ?></label>
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label
                                                            for="exampleInputEmail1"><?php echo lang('skype_id'); ?></label>
